  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Welcome to Try N Sell",
      });
    }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-primary mb-2">Join as Customer</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Create your account and start earning rewards</p>
          </div>
